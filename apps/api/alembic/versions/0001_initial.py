...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=200), nullable=False),
        sa.Column("host_patterns", postgresql.JSONB(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=False), primary_key=True),
        sa.Column("organization_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("organizations.id"), nullable=False),
        sa.Column("site_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("sites.id"), nullable=False),
    ...
    op.create_table(
        "chapters",
        sa.Column("id", postgresql.UUID(as_uuid=False), primary_key=True),
        sa.Column("course_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("courses.id"), nullable=False),
    ...
    op.create_table(
        "timeline_events",
        sa.Column("id", postgresql.UUID(as_uuid=False), primary_key=True),
        sa.Column("video_session_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("video_sessions.id"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("course_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("courses.id"), nullable=False),
        sa.Column("chapter_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("chapters.id"), nullable=False),
        sa.Column("video_session_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("video_sessions.id"), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("organization_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("organizations.id"), nullable=False),
        sa.Column("user_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("users.id"), nullable=True),
        sa.Column("course_id", postgresql.UUID(as_uuid=False), sa.ForeignKey("courses.id"), nullable=True),
